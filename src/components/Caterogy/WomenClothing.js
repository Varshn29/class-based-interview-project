...
class WomenClothing extends Component {
    ...
    render() {
        return (
            <Container>
                <Typography variant='h5' sx={{ textAlign: 'center', mt: '30px', mb: '40px' }}>Displaying Women's clothing</Typography>
...
export default connect(mapStateToProps, mapDispatchToProps)(WomenClothing)